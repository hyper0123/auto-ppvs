...
# API Endpoints
STREAMS_API = "https://ppvs.su/api/streams"
STREAM_DETAILS_API = "https://ppvs.su/api/streams/{}"
OUTPUT_FILE = "ppvs_playlist.m3u"
...
def fetch_streams():
    """Fetch the list of available streams from PPVS.SU."""
    print("📡 Fetching streams from PPVS.SU...")
